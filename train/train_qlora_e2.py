...
def main():
    ...
    print(f"[E2] 训练集样本数: {len(train_dataset)}")
    print(f"[E2] 验证集样本数: {len(eval_dataset)}")

    # 2. 文本 → token
    max_length = tokenizer.model_max_length
    print(f">>> [E2] 将文本 tokenize，max_length={max_length} ...")
    ...
    print("E2 训练完成！LoRA 权重已保存在：", OUTPUT_DIR)
